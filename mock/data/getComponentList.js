...
function genComponentList() {
    return [
        // Info
        {
            fe_id: "c1", // 由于统计页，左侧和中间需要数据完全一致，要将fe_id写死
        ...
        // Title
        {
            ...
            title: "标题", //组件标题
            isHidden: false, //组件隐藏状态
            isLocked: false, //组件锁定状态
            props: { text: "个人信息调研", level: 1, isCenter: false } //组件属性
        },
        // Input
        {
            fe_id: "c3",
...
module.exports = genComponentList